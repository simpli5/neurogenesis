...
<head>
  ...
  <link rel="shortcut icon" sizes="all" href="assets/imgs/neurogenesis_monogram.php" type="image/svg+xml" />
...
<body>
  ...
  <!--
	...
	-->
  <a id="ctas" href="tel://+16054840560" class="mdl-button mdl-js-button mdl-button--fab mdl-button--raised mdl-js-ripple-effect mdl-button--colored mdl-color-text--white">
